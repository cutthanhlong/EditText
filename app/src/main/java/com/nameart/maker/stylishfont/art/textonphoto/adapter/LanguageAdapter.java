...
public class LanguageAdapter extends RecyclerView.Adapter<LanguageAdapter.LangugeViewHolder> {
    ...
    public LanguageAdapter(List<Language> languageList, IClickItemLanguage listener, Context context) {
...
//        if (language.getActive()) {
//            holder.imgCheckLanguage.setImageResource(R.drawable.ic_language_check);
//        } else {
//            holder.imgCheckLanguage.setImageResource(R.drawable.ic_language_no_check);
//        }
//        holder.imgCheckLanguage.setImageResource(R.drawable.ic_language_no_check);
    ...
    public class LangugeViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView imgCheckLanguage;
